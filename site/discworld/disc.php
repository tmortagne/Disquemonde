...
<title>C'est quoi le Disque-monde de Terry Pratchett? -- A'TUIN</title>
	<meta name="auteur" content="Tuska M." />
	<meta name="date" content="25 Novembre 2000" />
	<meta name="DESCRIPTION" content="Description géographique et anatomique du Disque-Monde" />
...
<body>
  <div align="center"><img src="images/disc_titre.gif" width="350" height="50" /></div>

  <br /><br /><br /><br />
  <img src="images/cover2.jpg" width="250" heigth="250" align="left" height="203" /> 
<p class="p1">Le Disque-Monde est un monde rond et plat qui repose sur le dos de quatre éléphants 
	...
	mal ! Cette théorie porte le nom de "Big Bang" ou de "Grande Secousse".</p>
<p class="p">Le Disque-Monde est un monde médiéval fantastique. Tous les personnages et créatures typiques y sont 
	...
	<a href="../persos/rincevent.html">Rincevent</a>, le meilleur plus mauvais magicien du 
	monde. <a href="../persos/bagage.html">Le Bagage</a>, coffre avec des centaines de petites 
	pattes, un estomac en béton armé et une rangée de dents. Cohen le barbare, 100 ans, 
	plus de dents, sciatique et rhumatisme, et pourtant le meilleur ! Le <a href="../persos/biblioth.html">Bibliothécaire</a> de 
	l'Université Invisible, un Orang-Outang. <a href="../persos/granny.html">Mémé Ciredutemps</a>, 
	une vieille sorcière et la <a href="../persos/mort.html">MORT</a>, en fait une partie, 
	Azraèl, seul personnage présent dans toutes les Annales.</p>

	<p class="p1"><i>"Dans un ensemble lointain de dimensions récupérées à la casse, 
	dans un plan astral nullement conçu pour planer, les tourbillons de 
	brumes stellaires frémissent et s'écartent...<br />
	Voyez...<br />
	...
	et de poussière d'astéroïdes. Elle fixe le But Ultime.<br />
	Dans sons cerveau plus grand q'une ville, avec une lenteur géologique, 
	Elle ne songe qu'au Fardau.<br />
	Une bonne partie du fardeau est évidemment due à Bérilia, Tubul, 
  	Ti-Phon l'Immense et<img src="images/discw.gif" align="right" width="135" height="198" /> 
  	...
  	son vaste pourtour et que surplombe le dôme bleu layette des Cieux.<br />
	</i></p>
	
	<p class="p"><i>L'astropsychologie n'est toujours pas parvenue à établir à quoi ils 
	pensent.<br />
	...
	par-delà les voiles de brume."</i>Cette citation est tiré du premier 
	livre de la série du Disque-Monde: <a href="../biblio/biblio_base.php?book=the_colour_of_magic&lang=fr_fr">La huitième 
	couleur (The colour of magic)</a></p>
	<br />
	
	<hr/>

	
<p align="center"><u><strong><font size="+1">Géographie du Disque-Monde</font></strong></u></p>
<br />
<a href="images/turtledisc.jpg" target="_blank"><img src="images/turtledisc2.jpg" alt="cliquez pour la voir en plus grand" width="49" height="50" />Une 
carte du Disque-Monde par John Kidby</a><br />

	<p class="p1">La géographie sur le Disque-monde n'est pas très précise. On peut 
	...
	Ces quatres continents sont décrit ci-dessous</p>
<ul>
		  <li><p class="p"><strong>Le Continent Sans Nom</strong>, représente à peut de chose près le centre névralgique 
			...
			On y retrouves les villes de Sto Lat, Quirm, Pseudopolis, Olive-Oued et évidemment Ankh-Morpork.</p></li>
		  <li><p class="p"><strong>Le Continent de Klatch</strong> peut, sans trop ce tromper, être qualifié d'Afrique 
			du Disque-Monde. On retrouve toute une panoplie de pays "méditerranéens". Les principaux 
			pays du continent sont Le Jolhimôme, Ephèbe, Omnia et l'empire capitale Klatch.</p></li>
		  <li><p class="p"><strong>Le Continent Contrepoids</strong> est très petit et est composé 
			...
			valeur (c'est bien le seul endroit sur le disque).</p></li>
		  <li><p class="p"><strong>Le Continent XXXX</strong> est quasiment inconnu. Il est souvent considéré comme un mythe. 
			...
			qui ne se nourrirait que de crevettes et glisseraient sur l'eau à l'aide de planche.</p></li>
</ul>

	<p class="p1">Mais il n'y a pas que les continents sur le disque, il y a aussi les 
	villes. Voici une petite liste des villes les plus connues du disque :</p>
	<a name="ankh"></a>	
<ul>
  <li> 
    <p class="p"><strong>Ankh-Morpork</strong> <img src="images/ankh.gif" width="224" hight="185" align="left" alt="Le blason d'Ankh-Morpork" height="197" /> 
      ...
      est construite sur du Terreau, en réalité elle est construite sur Ankh Morpork.<br />
      Le blason d'Ankh-Morpork contient deux devises:<br />
      <br />
      MERVS IN PECTVM ET IN AQVAM - Pur en esprit et en eau<br />
      Et<br />
      QVANTI CANICVLA ILLE IN FENESTRA - Combien est ce petit chien dans la vitrine<br />
      <br />
      ...
      il circule une rumeur comme quoi un héritier du trône erre dans la ville.<br />
      ...
      par les guildes.<br />
      Beaucoup de secteurs différents composent la grande ville d'Ankh-Morpork<br />
      Les Ombres, Pseudopolis, le Tambour Rafistolé.</p>
  </li>
  <li>
    <p class="p"><strong>Lancre</strong> <img src="images/soeurs.jpg" align="right" alt="Les 3 soeurcières" width="174" height="222" /> 
      ...
      sorcières <a href="../persos/granny.html">Esmé Ciredutemps</a>, <a href="../persos/magrat.html">Magrat 
      Goussedail</a> et <a href="../persos/nanny.html">Gytha Ogg</a>.</p>
  </li>
  <li> 
    <p class="p"><strong>Le Jolhimôme</strong>, appellé aussi Vieux Royaume et 
      ...
      grandissant sur les terres fertiles, Pyramides.</p>
  </li>
  <li> 
    <p class="p"><strong>Ephèbe</strong>.<br />
      Système politique: tyranie (forme de démocratie).<br />
      Principale exportation: idées.<br />
      ...
      du bain directement dans la rue en crant <strong>"Eurêka !"</strong> (qui 
      se traduit par : "Une serviette, donnez moi une serviette.").</p>
  </li>
  <li> 
    <p class="p"><strong>Omnia</strong> ou la cité du dieu Om. On y a dépassé 
      ...
      n'est pas rond et en orbite autour du soleil.</p>
  </li>
  <li> 
    <p class="p"><strong>Cori Celesti</strong>, placé au centre du Moyeu, n'est 
      ...
      comment occuper un après midi pluvieux.</p>
  </li>
</ul>
<hr />
  ...
  <tr> 
    <td align="center">
      <a href="<?php echo $mail_link; ?>" onclick="window.open('<?php echo $mail_link; ?>', '', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=300'); return false;" title="Reveal this e-mail address">
        <img src="../general/mail.gif" border="0" width="65" height="35" /> 
